...
def collect_data(city_code='1452'):
    ...
    with open(f'index_magnit.html', 'w', encoding="utf-8" ) as file:
        file.write(response.text)
    
    with open('index_magnit.html', encoding="utf-8") as file:
        src = file.read()
    ...
    with open(f'{city}_{cur_time}.csv', "w", encoding="utf-8-sig" ) as file:
    ...
    for card in cards:
        ...
        with open(f'{city}_{cur_time}.csv', "a", encoding="utf-8-sig") as file:
            writer = csv.writer(file)
